...
public class ControladorCliente {
	...
	private ModeloCliente modeloSocio;
	...
	public void abrirFormDeBorrado() {
		ArrayList<Cliente> socios = this.modeloSocio.seleccionarTodos();
	...
	public void rellenarFormDeBorrado(int idSocio) {
		Cliente socio = this.modeloSocio.select(idSocio);
	...
	public ModeloCliente getModeloSocio() {
		return modeloSocio;
	}

	public void setModeloSocio(ModeloCliente modeloSocio) {
	...
	public void mostrarSociosPorNombre(String nombre) {
		ArrayList<Cliente> socios = this.modeloSocio.selectLikeNombre(nombre);
		this.formularioBusquedaSocio.rellenarTabla(socios);
	}

	public void mostrarSociosPorApellido(String apellido) {
		ArrayList<Cliente> socios = this.modeloSocio.selectLikeApellido(apellido);
		this.formularioBusquedaSocio.rellenarTabla(socios);
	}

	public void mostrarSociosPorDireccion(String direccion) {
		ArrayList<Cliente> socios = this.modeloSocio.selectPorDireccion(direccion);
		this.formularioBusquedaSocio.rellenarTabla(socios);
	}

	public void mostrarSociosPorPoblacion(String poblacion) {
		ArrayList<Cliente> socios = this.modeloSocio.selectPorPoblacion(poblacion);
		this.formularioBusquedaSocio.rellenarTabla(socios);
	}

	public void mostrarSociosPorProvincia(String provincia) {
		ArrayList<Cliente> socios = this.modeloSocio.selectPorProvincia(provincia);
		this.formularioBusquedaSocio.rellenarTabla(socios);
