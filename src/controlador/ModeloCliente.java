...
public class ModeloCliente extends Conectar {
	...
	public void insertar(Cliente socio) throws Exception {
	...
	public int modificar(Cliente socio) {
		int lineascambiadas;
		try {
	...
	public ArrayList<Cliente> seleccionarDni(String dni) throws Exception {
		...
		try {
			...
			rs.next();
			Cliente socio = new Cliente(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),
	...
	public Cliente select(int idSocio) {
	...
	public ArrayList<Cliente> selectLikeNombre(String nombre) {
		...
		try {
			...
			while (rs.next()) {
				Cliente socio = new Cliente(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4),
